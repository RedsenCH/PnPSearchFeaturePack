...
export interface IPanelEnhancedState {
...
export class PanelEnhancedComponent extends React.Component<IPanelEnhancedComponentProps, IPanelEnhancedState> {
    ...
    constructor(props: IPanelEnhancedComponentProps) {
        super(props);
        ...
        const panelProps: IPanelProps = {
            ...
            onRenderBody: () => {
                ...
                return <div style={{
                    overflow: 'auto',
                    marginLeft: 15
                }} dangerouslySetInnerHTML={{ __html: this.props.contentTemplate }}>
                </div>;
            }
        };
        ...
        return <div>
            <Text theme={this.props.themeVariant as ITheme}>
                <div
                    ...
                    dangerouslySetInnerHTML={{ __html: this.props.openTemplate }}>
                </div>
            </Text>
            <Panel {...panelProps} />
        </div>;
