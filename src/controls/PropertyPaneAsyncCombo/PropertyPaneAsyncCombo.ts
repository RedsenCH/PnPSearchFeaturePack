...
export interface IPropertyPaneAsyncComboInternalProps
    extends IPropertyPaneAsyncComboProps,
        IPropertyPaneCustomFieldProps {}
...
export class PropertyPaneAsyncCombo
    implements IPropertyPaneField<IPropertyPaneAsyncComboProps>
{
    ...
    constructor(
        ...
        properties: IPropertyPaneAsyncComboProps
    ) {
