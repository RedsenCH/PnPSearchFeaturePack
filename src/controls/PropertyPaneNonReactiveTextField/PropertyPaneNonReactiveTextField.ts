...
export interface IPropertyPaneNonReactiveTextFieldInternalProps
    extends IPropertyPaneNonReactiveTextFieldProps,
        IPropertyPaneCustomFieldProps {}

export class PropertyPaneNonReactiveTextField
    implements
        IPropertyPaneField<IPropertyPaneNonReactiveTextFieldInternalProps>
{
    ...
    constructor(
        ...
        properties: IPropertyPaneNonReactiveTextFieldProps
    ) {
